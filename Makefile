#############################################################################
# Makefile for building: TheMazeRunner
# Generated by qmake (3.0) (Qt 5.2.1)
# Project:  TheMazeRunner.pro
# Template: app
# Command: /usr/lib/i386-linux-gnu/qt5/bin/qmake -spec linux-g++ -o Makefile TheMazeRunner.pro
#############################################################################
...
LINK          = g++
LFLAGS        = -Wl,-O1
LIBS          = $(SUBLIBS) -lsfml-graphics -lsfml-window -lsfml-system -lQt5Widgets -L/usr/lib/i386-linux-gnu -lQt5Gui -lQt5Core -lGL -lpthread 
AR            = ar cqs
RANLIB        = 
...
Makefile: TheMazeRunner.pro /usr/lib/i386-linux-gnu/qt5/mkspecs/linux-g++/qmake.conf /usr/lib/i386-linux-gnu/qt5/mkspecs/features/spec_pre.prf \
		/usr/lib/i386-linux-gnu/qt5/mkspecs/common/shell-unix.conf \
		/usr/lib/i386-linux-gnu/qt5/mkspecs/common/unix.conf \
		/usr/lib/i386-linux-gnu/qt5/mkspecs/common/linux.conf \
		/usr/lib/i386-linux-gnu/qt5/mkspecs/common/gcc-base.conf \
	...
	$(QMAKE) -spec linux-g++ -o Makefile TheMazeRunner.pro
...
dist: 
	@test -d .tmp/TheMazeRunner1.0.0 || mkdir -p .tmp/TheMazeRunner1.0.0
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/TheMazeRunner1.0.0/ && $(COPY_FILE) --parents maze.h sprite.h mazeTypes.h defines.h entity.h .tmp/TheMazeRunner1.0.0/ && $(COPY_FILE) --parents main.cpp maze.cpp sprite.cpp entity.cpp .tmp/TheMazeRunner1.0.0/ && (cd `dirname .tmp/TheMazeRunner1.0.0` && $(TAR) TheMazeRunner1.0.0.tar TheMazeRunner1.0.0 && $(COMPRESS) TheMazeRunner1.0.0.tar) && $(MOVE) `dirname .tmp/TheMazeRunner1.0.0`/TheMazeRunner1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/TheMazeRunner1.0.0
